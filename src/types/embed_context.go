...
func (c *Context) GetCtx(e echo.Context) error {
	...
	if err != nil {
		return merrors.ContextGetError{Package: "types", Struct: "Context", Function: "GetCtx"}.Wrap(err).Log()
	}
...
func (c Context) ToModel() (*models.Context, error) {
	...
	if err != nil {
		return nil, merrors.JSONMarshallingError{Package:"types", Struct:"Context", Function: "ToModel"}.Wrap(err).Log()
	}
	r := models.Context{}
	if err := json.Unmarshal(b, &r); err != nil {
		return nil, merrors.JSONUnmarshallingError{Package:"types", Struct:"Context", Function: "FromModel"}.Wrap(err).Log() 
	}
	return &r, nil
}
...
func (c *Context) FromModel(ptr *models.Context) error {
	if ptr != nil {
		...
		if err != nil {
			return merrors.JSONMarshallingError{Package:"types", Struct:"Context", Function: "FromModel"}.Wrap(err).Log()
		}
		d := Context{}
		if err := json.Unmarshal(b, &d); err != nil {
			return merrors.JSONUnmarshallingError{Package:"types", Struct:"Context", Function: "FromModel"}.Wrap(err).Log()
		}
		c = &d
	}
	return nil
