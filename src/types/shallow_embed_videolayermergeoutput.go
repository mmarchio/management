...
func (c ShallowVideoLayerMergeOutput) Expand(e echo.Context) (*VideoLayerMergeOutput, error) {
...
func (c *ShallowVideoLayerMergeOutput) Unmarshal(e echo.Context, j string) error {
	return json.Unmarshal([]byte(j), c)
}

func (c ShallowVideoLayerMergeOutput) Marshal(e echo.Context) (string, error) {
	b, err := json.Marshal(c)
	return string(b), err
}
